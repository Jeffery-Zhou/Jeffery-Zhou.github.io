...
profile:
  ...
  more_info: >
    <p>19w, 1215-1220, Hong Kong Science and Technology Park</p>
...
<div class="row mt-6">
    <div class="col-sm mt-6 mt-md-0">
        {% include video.html path="assets/video/7_tool_manipulation.mp4" class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
    </div>
</div>
<div class="caption">
    This is our new experimental results on tool manipulation project.
</div>